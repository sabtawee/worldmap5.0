...
if(OLud('textfont'))var ol_textfont="Tahoma";
if(OLud('captionfont'))var ol_captionfont="Tahoma";
if(OLud('closefont'))var ol_closefont="Tahoma";
...
if(OLud('width'))var ol_width=400;
